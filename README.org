...
* usage
  ...
  2. used as function
     ...
     after install basic environment installation, you can use the bash function
     privode by install-utils seperately. for example you just want to install rvm.
